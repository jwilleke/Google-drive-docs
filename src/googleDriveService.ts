...
export class GoogleDriveService {
  ...
  /**
   * 
   * @param name - name of entity to be created
   * @param mimeType - mimeType of entity to be created
   * @returns 
   */
  createEntry(name: string, mimeType: string): Promise <PartialDriveFile> {
